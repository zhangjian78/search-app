...
import jerry.gadgets.gsearch.NotificationService.Companion.CHANNEL_ID
import jerry.gadgets.gsearch.NotificationService.Companion.CHANNEL_NAME
import jerry.gadgets.gsearch.NotificationService.Companion.REPLY_ACTION
...
class ReplyActivity : AppCompatActivity() {
    ...
    private val btnSend: ImageButton? by lazy { findViewById(R.id.button_send) }
    private val etReplay: EditText? by lazy { findViewById(R.id.edit_reply) }
    ...
    private fun sendMessage(notifyId: Int, messageId: Int) {
        ...
        val message = etReplay.toString().trim { it <= ' ' }
