...
public class MyADMLegacyMessageHandler extends ADMMessageHandlerBase {
    ...
    public static final String TAG = "AMZ_ADM_OLD";

    public MyADMLegacyMessageHandler() {
        super(MyADMLegacyMessageHandler.class.getName());
    }

    public MyADMLegacyMessageHandler(String className) {
        super(className);
    }
    ...
    protected void onMessage(final Intent intent)
    {
        ...
        DeviceMessageManager.dmAware.onIntentFromMessaging(this, intent);
    }
}
